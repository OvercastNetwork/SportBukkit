...
java -jar builddata/bin/SpecialSource.jar --kill-lvt -i "temp/member.jar" --access-transformer "builddata/mappings/bukkit-${NMS_VERSION}.at" -m "builddata/mappings/package.srg" -o "temp/mapped.jar"
